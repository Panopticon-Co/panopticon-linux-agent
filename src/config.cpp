...
result<agent_config> parse_config(const std::string_view contents) {
    ...
    constexpr std::array<std::string_view, 8U> allowed{"manager_url", "agent_id", "host_id", "queue_capacity", "spool_quota_bytes", "maximum_event_bytes", "maximum_batch_bytes", "response_enabled"};
